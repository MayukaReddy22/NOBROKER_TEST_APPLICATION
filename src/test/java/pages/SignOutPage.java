...
public class SignOutPage {
	...
	public boolean clickSignOut() {
		try {
			...
			WebElement signoutBtn = wait.until(ExpectedConditions.elementToBeClickable(Locators.signOutBtn1));
			signoutBtn.click();
			return true;
		} catch (TimeoutException te) {
	...
	public boolean verifySignout() {
		try {
			wait.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath("//*[@id=\"navHeader\"]/div[5]/div[2]/div[2]/div")));
